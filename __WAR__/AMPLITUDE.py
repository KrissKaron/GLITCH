...
class CSVExcavator:
    def __init__(self, path_root):
        self.PATH_GENERAL_NEWS = f'{path_root}/csv/general_news.csv'
        self.PATH_INTEREST_RATE = f'{path_root}/csv/interest_rate.csv'
        self.PATH_REGULATORY_NEWS = f'{path_root}/csv/regulatory_news.csv'
        self.PATH_WHALES_100K = f'{path_root}/csv/whale_transaction_count_100k_usd_to_inf_data.csv'
        self.PATH_WHALES_1M = f'{path_root}/csv/whale_transaction_count_1m_usd_to_inf_data.csv'
...
class CSVCompacter:
    def __init__(self, general_news_df, interest_rate_df, regulatory_news_df, whale_transactions_df):
        ...
        self.output_path = "/home/krisskaron/GLITCH_1.21.4/__WAR__/NEWS.csv"
    ...
    def standardize_columns(self):
        ...
        # Add missing columns to ensure consistency across all DataFrames
